...
class ShallowTransform(object):
    ...
    def __repr__(self):
        return "<ShallowTransform offset(%3.3f,%3.3f) scale(%3.3f,%3.3f) rotation(%3.3f,%3.3f)>" % (
            self.offset[0], self.offset[1], self.scale[0], self.scale[1], self.rotation[0], self.rotation[1])
