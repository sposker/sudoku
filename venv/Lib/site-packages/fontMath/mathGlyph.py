...
class MathGlyph(object):
    ...
    def drawPoints(self, pointPen, filterRedundantPoints=False):
        ...
        for component in self.components:
            pointPen.addComponent(component["baseGlyph"], component["transformation"],
...
def _processMathOneComponents(componentPairs, func):
    ...
    for component1, component2 in componentPairs:
        ...
        component["transformation"] = _processMathOneTransformation(component1["transformation"],
                                                                    component2["transformation"], func)
