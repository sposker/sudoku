...
class BaseConverter(object):
    ...
    def __init__(self, name, repeat, aux, tableClass=None):
        ...
        self.isPropagated = name in ["ClassCount", "Class2Count", "FeatureTag", "SettingsCount", "VarRegionCount",
                                     "MappingCount", "RegionAxisCount", 'DesignAxisCount', 'DesignAxisRecordSize',
                                     'AxisValueCount', 'ValueRecordSize', 'AxisCount']
