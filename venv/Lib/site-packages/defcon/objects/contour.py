    ...
    **This object posts the following notifications:**
        ...
        **preserveCurve** is True, the contour will
        ...
        # if have a curve, do the preservation
            ...
            result = bezierMath.joinSegments((previousOnCurveX, previousOnCurveY),
                                             ...
                                             (nextOffCurve1X, nextOffCurve1Y), (nextOffCurve2X, nextOffCurve2Y),
                                             (nextOnCurveX, nextOnCurveY))
            # remove the segment
            for point in segment:
                self._points.remove(point)
    ...
    def _splitAndInsertAtSegmentAndT(self, segmentIndex, t, insert):
        ...
        if segmentType == "line":
            ...
            pointsToInsert = [(pt2, None, False), (pt3, None, False), (pt4, "curve", True), (pt6, None, False),
                              (pt7, None, False)]
        ...
        if insert:
            ...
            newPoints = [self._pointClass(pos, segmentType=segmentType, smooth=smooth) for pos, segmentType, smooth in
                         pointsToInsert]
    ...
    def drawPoints(self, pointPen):
        ...
        for point in self._points:
            try:
                pointPen.addPoint((point.x, point.y), segmentType=point.segmentType, smooth=point.smooth,
                                  name=point.name, identifier=point.identifier)
            except TypeError:
                pointPen.addPoint((point.x, point.y), segmentType=point.segmentType, smooth=point.smooth,
                                  name=point.name)
