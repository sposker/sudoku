...
class Glyph(BaseObject):
    ...
    **This object posts the following notifications:**
    ...
    representationFactories = {
        "defcon.glyph.area": dict(
            ...
            destructiveNotifications=(
                "Glyph.ContoursChanged", "Glyph.ComponentsChanged", "Glyph.ComponentBaseGlyphDataChanged")
        )
    }
    ...
    bottomMargin = property(_get_bottomMargin, _set_bottomMargin,
                            doc="The bottom margin of the glyph. Setting this post *Glyph.HeightChanged* and *Glyph.Changed* notifications among others.")
    ...
    topMargin = property(_get_topMargin, _set_topMargin,
                         doc="The top margin of the glyph. Setting this posts *Glyph.HeightChanged*, *Glyph.VerticalOriginChanged* and *Glyph.Changed* notifications among others.")
    ...
    markColor = property(_get_markColor, _set_markColor,
    ...
    verticalOrigin = property(_get_verticalOrigin, _set_verticalOrigin,
                              doc="The glyph's vertical origin. Setting this posts *Glyph.VerticalOriginChanged* and *Glyph.Changed* notifications.")
    ...
    def beginSelfComponentNotificationObservation(self, component):
        ...
        component.addObserver(observer=self, methodName="_componentBaseGlyphDataChanged",
        ...
        # adding image
            ...
            if set(self._image.items()) != set(image.items()):
                ...
                self._image.transformation = (
                    image["xScale"], image["xyScale"], image["yxScale"], image["yScale"], image["xOffset"],
                    image["yOffset"])
