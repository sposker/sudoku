...
class Font(BaseObject):
    ...
    **This object posts the following notifications:**
    ...
    def __init__(self, path=None,
                 kerningClass=None, infoClass=None, groupsClass=None, featuresClass=None, libClass=None,
                 unicodeDataClass=None,
                 layerSetClass=None, layerClass=None, imageSetClass=None, dataSetClass=None,
                 guidelineClass=None,
                 glyphClass=None, glyphContourClass=None, glyphPointClass=None, glyphComponentClass=None,
                 glyphAnchorClass=None, glyphImageClass=None):
        ...
        if path:
            ...
            for layerName in layerNames:
                glyphSet = reader.getGlyphSet(layerName, validateRead=self._layers.ufoLibReadValidate,
                                              validateWrite=self._layers.ufoLibWriteValidate)
    ...
    dispatcher = property(_get_dispatcher,
    ...
    ufoFormatVersion = property(_get_ufoFormatVersion,
    ...
    kerningGroupConversionRenameMaps = property(_get_kerningGroupConversionRenameMaps,
    ...
    def beginSelfLayerSetNotificationObservation(self):
        ...
        layers.addObserver(observer=self, methodName="_layerAddedNotificationCallback",
                           notification="LayerSet.LayerAdded")
        layers.addObserver(observer=self, methodName="_layerWillBeDeletedNotificationCallback",
    ...
    def save(
        ...
        try:
            ...
            if formatVersion >= 3:
                self.saveImages(writer=writer, removeUnreferencedImages=removeUnreferencedImages, saveAs=saveAs,
    ...
    def saveImages(self, writer, removeUnreferencedImages=False, saveAs=False, progressBar=None):
        ...
        self.images.save(writer, removeUnreferencedImages=removeUnreferencedImages, saveAs=saveAs,
                         progressBar=progressBar)
        if progressBar is not None:
            progressBar.update()
    ...
    guidelines = property(_get_guidelines, _set_guidelines,
