    ...
    **This object posts the following notifications:**
    ...
    def _set_defaultLayer(self, layer):
        ...
        self.postNotification(notification="LayerSet.DefaultLayerChanged",
                              data=dict(oldValue=oldName, newValue=layer.name))
        self.dirty = True

    defaultLayer = property(_get_defaultLayer, _set_defaultLayer,
    ...
    layerOrder = property(_get_layerOrder, _set_layerOrder,
    ...
    def save(self, writer, saveAs=False, progressBar=None):
        ...
        if writer.formatVersion < 3:
            ...
            glyphSet = writer.getGlyphSet(layerName=None, defaultLayer=True, validateRead=self.ufoLibReadValidate,
                                          validateWrite=self.ufoLibWriteValidate)
    ...
    def reloadLayers(self, layerData):
        ...
        for layerName, l in layerData.get("layers", {}).items():
            ...
            if layerName not in currentLayerOrder:
                glyphSet = reader.getGlyphSet(layerName, validateRead=self.ufoLibReadValidate,
