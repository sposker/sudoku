...
class LayoutEngine(BaseObject):
    ...
    **This object posts the following notifications:**
    ...
    def beginSelfLayersObservation(self):
        ...
        layers.addObserver(observer=self, methodName="_layerSetDefaultLayerWillChange",
                           notification="LayerSet.DefaultLayerWillChange")
        layers.addObserver(observer=self, methodName="_layerSetDefaultLayerChanged",
    ...
    def beginSelfLayerObservation(self):
        ...
        layer.addObserver(observer=self, methodName="_layerGlyphUnicodesChanged",
