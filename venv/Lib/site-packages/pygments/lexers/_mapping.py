...
LEXERS = {
    ...
    'CommonLispLexer': (
        'pygments.lexers.lisp', 'Common Lisp', ('common-lisp', 'cl', 'lisp'), ('*.cl', '*.lisp'),
        ('text/x-common-lisp',)),
    ...
    'GenshiTextLexer': (
        'pygments.lexers.templates', 'Genshi Text', ('genshitext',), (),
    ...
    'LighttpdConfLexer': (
        'pygments.lexers.configs', 'Lighttpd configuration file', ('lighty', 'lighttpd'), (),
    ...
    'LiterateAgdaLexer': (
        'pygments.lexers.haskell', 'Literate Agda', ('lagda', 'literate-agda'), ('*.lagda',),
    ...
    'MIMELexer': (
        'pygments.lexers.mime', 'MIME', ('mime',), (),
    ...
    'PhpLexer': (
        'pygments.lexers.php', 'PHP', ('php', 'php3', 'php4', 'php5'), ('*.php', '*.php[345]', '*.inc'),
        ('text/x-php',)),
    ...
    'RedLexer': (
        'pygments.lexers.rebol', 'Red', ('red', 'red/system'), ('*.red', '*.reds'),
    ...
    'RexxLexer': (
        'pygments.lexers.scripting', 'Rexx', ('rexx', 'arexx'), ('*.rexx', '*.rex', '*.rx', '*.arexx'),
        ('text/x-rexx',)),
    'RhtmlLexer': (
    ...
    'RobotFrameworkLexer': (
        'pygments.lexers.robotframework', 'RobotFramework', ('robotframework',), ('*.robot',),
    ...
    'SchemeLexer': (
        'pygments.lexers.lisp', 'Scheme', ('scheme', 'scm'), ('*.scm', '*.ss'),
    ...
    'SourcesListLexer': (
        'pygments.lexers.installers', 'Debian Sourcelist', ('sourceslist', 'sources.list', 'debsources'),
        ('sources.list',),
        ()),
