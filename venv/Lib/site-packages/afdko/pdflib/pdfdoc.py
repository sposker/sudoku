...
class PDFDocument:
    ...
    def writeTrailer(self, f):
        ...
        f.write(('<< /Size %d /Root %d 0 R /Info %d 0 R>>' % (len(self.objects) + 1, 1, self.infopos) + LINEEND).encode(
            'utf-8'))
    ...
    def addFont(self, psname, encoding=kDefaultEncoding, clientCtx=None, getFontDescriptorItems=None,
                getEncodingInfo=None):
    ...
    def MakeType1Font(self, fontIndex, psName, encoding=kDefaultEncoding, clientCtx=None, getFontDescriptorItems=None,
                      getEncodingInfo=None):
...
class PDFEmbddedFont(PDFStream):
    ...
    def save(self, file):
        ...
        if self.compression:
            file.write(('<<  %s /Length %d /Filter [/ASCII85Decode /FlateDecode] >>' % (
...
class PDFType1Font(PDFObject):
    def __init__(self, key, psName, encoding=kDefaultEncoding, fontDescriptObjectNumber=None, type=kDefaultFontType,
                 firstChar=None, lastChar=None, widths=None):
