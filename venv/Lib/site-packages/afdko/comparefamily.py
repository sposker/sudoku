...
kLigFeatureList = ["clig", "dlig", "hlig", "rlig",
                   "liga"]  # List of ligature features; used to  load a dictionary of ligatures and their components, for width checks.

kKnownBaseTags = ["hang",
                  # The hanging baseline. This is the horizontal line from which syllables seem to hang in Tibetan script.
                  "icfb",
                  # ideographic character face bottom edge baseline. (See section Ideographic Character Face below for usage.)
                  "icft",
                  # Ideographic character face top edge baseline. (See section Ideographic Character Face below for usage.)
...
def readGlyphInfo(cmpfFont):
    ...
    if 'hmtx' in tables:
        ...
        tab_glyph_list2 = ["zero.taboldstyle", "one.taboldstyle", "two.taboldstyle", "three.taboldstyle",
                           "four.taboldstyle", "five.taboldstyle", "six.taboldstyle", "seven.taboldstyle",
                           "eight.taboldstyle", "nine.taboldstyle"]
        tab_glyph_list3 = ["zero.numerator", "one.numerator", "two.numerator", "three.numerator", "four.numerator",
                           "five.numerator", "six.numerator", "seven.numerator", "eight.numerator", "nine.numerator"]
...
def readNameTable(cmpfFont):
    ...
    for namerecord in name_table.names:
        cmpfFont.nameIDDict[
            (namerecord.platformID, namerecord.platEncID, namerecord.langID, namerecord.nameID)] = namerecord.string
    ...
    if cmpfFont.hasMacNames:
        ...
        try:
            ...
            print("	Error: Missing Mac Compatible Family Name from name table! Should be in record", (1, 0, 0, 1),
                  cmpfFont.PostScriptName1)
        ...
        try:
            ...
            print("	Error: Missing Mac Compatible SubFamily Name from name table! Should be in record", (1, 0, 0, 2),
                  cmpfFont.PostScriptName1)
        ...
        try:
            ...
            print("	Error: Missing Mac Full Font Name from name table! Should be in record", (1, 0, 0, 4),
                  cmpfFont.PostScriptName1)
        ...
        try:
            ...
            print("	Warning: Missing Mac Version String from name table! Should be in record", (1, 0, 0, 5),
                  cmpfFont.PostScriptName1)
        ...
        try:
            ...
            print("	Warning: Missing Mac Copyright String from name table! Should be in record", (1, 0, 0, 0),
                  cmpfFont.PostScriptName1)
        ...
        try:
            ...
            print("	Warning: Missing Mac Trademark String from name table! Should be in record", (1, 0, 0, 7),
                  cmpfFont.PostScriptName1)
        ...
        try:
            ...
            print("	Warning: Missing Mac platform License Notice URL  from name table! Should be in record",
                  (1, 0, 0, 14))
    ...
    try:
        ...
        print("	Error: Missing Windows PostScript Name/Unicode encoding from name table! Should be in record",
              (3, 1, 1033, 6), cmpfFont.PostScriptName3)
    ...
    try:
        ...
        print(
            "	Error: Missing Windows Compatible Family Name/Unicode encoding String from name table! Should be in record",
            (3, 1, 1033, 1), cmpfFont.PostScriptName3)
    ...
    try:
        ...
        print(
            "	Error: Missing Windows Compatible SubFamily Name/Unicode encoding String from name table! Should be in record",
            (3, 1, 1033, 2), cmpfFont.PostScriptName3)
    ...
    try:
        ...
        print(
            "	Error: Missing Windows Full Family Name/Unicode encoding String from name table! Should be in record",
            (3, 1, 1033, 4), cmpfFont.PostScriptName3)
        cmpfFont.FullFontName3 = ""

    try:
        cmpfFont.VersionStr3 = cmpfFont.nameIDDict[(3, 1, 1033, 5)].decode('utf_16_be')
    except KeyError:
        print("	Error: Missing Windows Version String/Unicode encoding String from name table! Should be in record",
              (3, 1, 1033, 5), cmpfFont.PostScriptName3)
    ...
    try:
        ...
        print(
            "	Warning: Missing Windows Copyright String/Unicode encoding String from name table! Should be in record",
            (3, 1, 1033, 0), cmpfFont.PostScriptName3)
    ...
    try:
        ...
        print(
            "	Warning: Missing Windows Trademark String/Unicode encoding String from name table! Should be in record",
            (3, 1, 1033, 7), cmpfFont.PostScriptName3)
    ...
    for style in styleList:
        ...
        if stylePat in cmpfFont.preferredFamilyName1:
            print(
                "	Error: Preferred family name '%s' contains the style name '%s'. This is usually confusing to users. %s" % (
                    cmpfFont.preferredFamilyName1, style, cmpfFont.PostScriptName1))
    ...
    for font in fontlist:
        if font.MacCompatibleFullName1:
            ...
            if key in nameDict:
                ...
                print(
                    "	Error: The first 32 chars of the Mac platform name ID 18 Compatible Full Name must be unique within Preferred Family Name group. name: '%s'. Conflicting fonts: %s." % (
                        font.MacCompatibleFullName1, nameDict[key]))
            else:
...
def doSingleTest2():
    ...
    for font in fontlist:
        ...
        if font.FullFontName1 in nameDict:
            ...
            print(
                "	Error: The Mac platform name ID 4 Preferred Full Name must be unique within Preferred Family Name group. name: '%s'. Conflicting fonts: %s." % (
                    nameDict[font.FullFontName1][0], nameDict[font.FullFontName1][-1]))
        else:
...
def doSingleTest3():
    ...
    for font in fontlist:
        if not font.FullFontName1.startswith(font.preferredFamilyName1):
            print(
                "	Error: Mac platform Full Name  name id 4) '%s' does not begin with the string used for font Preferred Family Name, '%s', for Font %s." % (
                    font.FullFontName1, font.preferredFamilyName1, font.PostScriptName1))
        ...
        if 'CFF ' in font.ttFont:
            try:
                ...
                if (font.FullFontName1 != cffFullName):
                    print(
                        "	Warning: Mac platform Full Name  name id 4) '%s' is not the same as the font CFF table Full Name, '%s', for Font %s." % (
                            font.FullFontName1, font.topDict.FullName, font.PostScriptName1))
                    print(
                        "This has no functional effect, as the CFF Full Name in an OpenType CFF table is never used. However, having different values for different copies of the same field and cause confusion when using font development tools.")
            except AttributeError:
...
def doSingleTest4():
    ...
    for font in fontlist:
        ...
        if not versionMatch:
            print(
                "	Error: could not find a valid decimal font version with the prefix 'Version ' or 'OTF ' in the name table name ID 5 'Version'  string: %s, for Font %s." % (
                    font.VersionStr1, font.PostScriptName1))
            continue
        if len(versionMatch.group(3)) != 3:
            print(
                "	Error: Version string does not have 3 decimal places in the name table name ID 5 'Version'  string: %s, for Font %s." % (
                    font.VersionStr1, font.PostScriptName1))
            continue
        ...
        if ver != font.OTFVersion:
            print(
                "Error: font version %.3f in name table name ID 5 'Version' string does not match the head table fontRevision value %.3f, for font %s." % (
                    ver, font.OTFVersion, font.PostScriptName1))
    ...
    for font in fontlist:
        if 'CFF ' in font.ttFont:
            ...
            if cffPSName != font.PostScriptName1:
                print(
                    "	Error: Postscript name in CFF table '%s' is not the same as name table Macintosh name ID 6 '%s'." % (
                        cffPSName, font.PostScriptName1))
        if font.PostScriptName3 != font.PostScriptName1:
            print("	Error: Windows name table name id 6 '%s' is not the same as Macintosh name ID 6 '%s'." % (
                font.PostScriptName3, font.PostScriptName1))
...
def doSingleTest6():
    ...
    for font in fontlist:
        ...
        if (1, 0, 0, 9) not in font.nameIDDict:
            print("	Error: Missing Mac Designer Note name id 9 from name table! Should be in record", (1, 0, 0, 9),
                  font.PostScriptName1)
        if (3, 1, 1033, 9) not in font.nameIDDict:
            print("	Error: Missing Windows Designer Note name id 9 from name table! Should be in record",
                  (3, 1, 1033, 9), font.PostScriptName1)
        if (1, 0, 0, 11) not in font.nameIDDict:
            print("	Error: Missing Mac Foundry URL name id 11 from name table! Should be in record", (1, 0, 0, 11),
                  font.PostScriptName1)
        else:
            foundryURL = font.nameIDDict[(1, 0, 0, 11)]
            if defaultURL and (defaultURL != foundryURL):
                print(
                    "	Error: Mac Foundry URL name id 11 '%s' is not the same as the default URL set by the environment variable CF_DEFAULT_URL '%s' for font %s." % (
                        defaultURL, foundryURL, font.PostScriptName1))

        if (3, 1, 1033, 11) not in font.nameIDDict:
            print("	Error: Missing Windows Foundry URL name id 11 from name table! Should be in record",
                  (3, 1, 1033, 11), font.PostScriptName1)

        if defaultFoundryCode and (defaultFoundryCode != font.achVendID):
            print(
                "	Error: OS/2 table foundry code '%s' is not the same as the default code set by the environment variable CF_DEFAULT_FOUNDRY_CODE '%s' for font %s." % (
                    font.achVendID, defaultFoundryCode, font.PostScriptName1))
...
def doSingleTest7():
    ...
    for font in fontlist:
        ...
        if glyphList:
            ...
            print("Error: font contains deprecated dotsection perator. These should be removed. %s. %s" % (
                font.PostScriptName1, glyphList))
        glyphList = re.findall(r"glyph[^{]+?\{([^,]+),[^[\]]+\sseac\s", report)
        if glyphList:
            glyphList = ", ".join(glyphList)
            print("Error: font contains deprecated seac operator. These composite glyphs must be decomposed. %s. %s" % (
                font.PostScriptName1, glyphList))
    ...
    for font in fontlist:
        if font.isBold == 0 and font.isItalic == 0:
            if font.compatibleSubFamilyName3 != "Regular":  # Unicode String
                print(
                    "	Warning: Style bit not set, Compatible SubFamily Name with Win Platform is not 'Regular' for Font",
                    font.PostScriptName3)
        elif font.isBold and font.isItalic == 0:
            if font.compatibleSubFamilyName3 != "Bold":  # Unicode String
                print(
                    "	Warning: Only Bold style bit set, Compatible SubFamily Name with Win Platform is not 'Bold' for Font",
                    font.PostScriptName3)
        elif font.isBold == 0 and font.isItalic:
            if font.compatibleSubFamilyName3 != "Italic":  # Unicode String
                print(
                    "	Warning: Only Italic style bit set, Compatible SubFamily Name with Win Platform is not 'Italic' for Font",
                    font.PostScriptName3)
            ...
            if font.compatibleSubFamilyName3 != "Bold Italic" and font.compatibleSubFamilyName3 != "Bold Italic":
                print(
                    "	Warning: Both Bold and Italic style bits set, Compatible SubFamily Name with Win Platform is not 'Bold Italic' for Font",
                    font.PostScriptName3)
    ...
    for font in fontlist:
        if font.isBold:
            ...
            if font.usWeightClass < 500:
                print("	Error: OS/2.usWeightClass is", font.usWeightClass, "and Bold bit is set for Font",
                      font.PostScriptName1)
            ...
            for fontDict in font.FDArray:
                try:
                    if fontDict.Private.ForceBold:
                        print("Warning: Font has ForceBold field. This is harmless, but is deprecated.",
                              font.PostScriptName1)
                except KeyError:
                    pass
...
def doSingleTest11():
    ...
    for font in fontlist:
        try:
            ...
            print(
                "	Error: font %s does not have a BASE table. This is necessary for users who are editing in a different script than the font is designed for." % (
                    font.PostScriptName1))
            return
        try:
            baseDict = {}
            for axisName in ['HorizAxis', 'VertAxis']:
                ...
                if not axisRecord.BaseScriptList.BaseScriptCount == len(axisRecord.BaseScriptList.BaseScriptRecord):
                    print(
                        "	Error: bad BASE table: %s.BaseScriptList.BaseScriptCount is not equal to the number of records in the list %s.BaseScriptList.BaseScriptRecord. %s." % (
                            axisName, axisName, font.PostScriptName1))
                    return
                if not axisRecord.BaseTagList.BaseTagCount == len(axisRecord.BaseTagList.BaselineTag):
                    print(
                        "	Error: bad BASE table: %s.BaseTagList.BaseTagCount is not equal to the number of tags in the list %s.BaseTagList.BaselineTag. %s." % (
                            axisName, axisName, font.PostScriptName1))
                    return
                for tag in axisRecord.BaseTagList.BaselineTag:
                    if not tag in kKnownBaseTags:
                        print("	Error: Base table tag '%s' not in list of registered BASE table tags. %s." % (
                            tag, font.PostScriptName1))
                baseDict[axisName] = {}
                for baseRecord in axisRecord.BaseScriptList.BaseScriptRecord:
                    ...
                    if not baseValues.BaseCoordCount == axisRecord.BaseTagList.BaseTagCount:
                        print(
                            "	Error: bad BASE table: %s.BaseTagList.BaseTagCount is not equal to %s.BaseScriptList.BaseScriptRecord.BaseScript.BaseValues.BaseCoordCount. %s." % (
                                axisName, axisName, font.PostScriptName1))
                        return
                    if not (axisRecord.BaseTagList.BaseTagCount == len(axisRecord.BaseTagList.BaselineTag)):
                        print(
                            "	Error: bad BASE table: number of records in list %s.BaseScriptList.BaseScriptRecord.BaseScript.BaseValues.BaseCoord is not equal to  %s.BaseScriptList.BaseScriptRecord.BaseScript.BaseValues.BaseCoordCount. %s." % (
                                axisName, axisName, font.PostScriptName1))
                        return
                    ...
                    if not scriptTag in kKnownScriptTags:
                        print("	Error: Base table script tag '%s' not in list of registered script  tags. %s." % (
                            scriptTag, font.PostScriptName1))
                    ...
                    for i in range(axisRecord.BaseTagList.BaseTagCount):
                        ...
                        if (defaultIndex == i) and (coord != 0):
                            print(
                                "\tWarning: default BASE table offset for script '%s', tag '%s' is non-zero (%s) for the default font BASE tag. %s." % (
                                    scriptTag, tag, coord, font.PostScriptName1))
                        elif tag == 'ideo':
                            calculatedValue = -(font.unitsPerEm - font.sCapHeight) / 2
                            diff = abs(coord - calculatedValue)
                            if diff > gDesignSpaceTolerance:
                                print(
                                    "\tWarning:  In order to center OS/2 Capheight in the ideo em-square, the BASE table offset for script '%s', tag '%s' should be '%s' rather than '%s'. %s." % (
                                        scriptTag, tag, calculatedValue, coord, font.PostScriptName1))
            # else:
        #	print("\tGood values calculatedValue %s , coord %s,font.sCapHeight %s " % (calculatedValue, coord, font.sCapHeight))
        except AttributeError as e:
            print(
                "	Error: I don't understand this BASE table: Could be bad BASE table, probably this programis out of date or incomplete. %s." % (
                    font.PostScriptName1))
    return
...
def doSingleTest12():
    ...
    for font in fontlist:
        if font.isItalic and (abs(font.italicAngle) <= 4):
            print(
                "\tWarning: Italic style bit is set, but Italic Angle '%s' is a smaller italic angle than -4 for Font %s." % (
                    font.italicAngle, font.PostScriptName1))
        if (font.italicAngle > 0.0):
            print(
                "\tWarning: Italic Angle '%s' is greater than zero. Is it really supposed to be leaning to the left, rather than the right?  %s." % (
                    font.italicAngle, font.PostScriptName1))
    for font in fontlist:
        if (not font.isItalic) and (abs(font.italicAngle) > 4):
            print(
                "\tWarning: Italic style bit is clear, but Italic Angle '%s' is a larger italic angle than -4 for Font %s." % (
                    font.italicAngle, font.PostScriptName1))
    ...
    for font in fontlist:
        ...
        if 'CFF ' in font.ttFont:
            if font.topDict.isFixedPitch != font.isFixedPitch:
                if font.isFixedPitch:
                    print(
                        "	Error: post table isFixedPitch indicates that the font is monospaced, but the CFF top dict IsFixedPitch is off.")
                else:
                    print(
                        "	Error: post table isFixedPitch indicates that the font is not monospaced, but the CFF top dict IsFixedPitch is on.")
        ...
        if font.isFixedPitch:
            ...
            if (numWidthEntries * 0.80 < numMostPopularWidth):
                print(
                    "	Warning: More than 80% of the glyphs in this font are the same width. Maybe it should be marked as FixedPitch. font",
                    font.PostScriptName1)
                for entry in widthTable[:-1]:
                    print("non-std width " + str(entry[1]) + " Number of glyphs " + str(entry[0]))
                    for name in entry[2]:
...
def doSingleTest14():
    ...
    for font in fontlist:
        if font.isItalic != font.isItalic2:
            print("	Error: Italic style bit in head.macStyle does not match with OS/2.fsSelection for Font",
                  font.PostScriptName1)
            print("\thead.macStyle:", font.isItalic, "OS/2.fsSelection:", font.isItalic2)
    for font in fontlist:
        if font.isBold != font.isBold2:
            print("	Error: Bold style bit in head.macStyle does not match with OS/2.fsSelection for Font",
                  font.PostScriptName1)
...
def doSingleTest15():
    ...
    for font in fontlist:
        ...
        if font.fontBBox[0] < -limit1 or font.fontBBox[0] > limit1:
            print("	Warning: BBox X-Min '%s' is out of usual range for Font %s." % (
                font.fontBBox[0], font.PostScriptName1))
        if font.fontBBox[1] < -limit2 or font.fontBBox[1] > limit2:
            print("	Warning: BBox Y-Min '%s' is out of usual range for Font %s." % (
                font.fontBBox[1], font.PostScriptName1))
        if font.fontBBox[2] < -limit1 or font.fontBBox[2] > limit1:
            print("	Warning: BBox X-Max '%s' is out of usual range for Font %s." % (
                font.fontBBox[2], font.PostScriptName1))
        if font.fontBBox[3] < -limit2 or font.fontBBox[3] > limit2:
            print("	Warning: BBox Y-Max '%s' is out of usual range for Font %s." % (
                font.fontBBox[3], font.PostScriptName1))
        ...
        if 'CFF ' in font.ttFont:
            ...
            if diff:
                print(
                    "The head table xMin, yMin, xMax, yMax values '%s' differ from the CFF table FontBBox values '%s'. %s." % (
                        headBox, cffBox, font.PostScriptName1))
...
def doSingleTest16():
    ...
    for font in fontlist:
        ...
        if diff != font.unitsPerEm:
            print(
                "	Warning: Difference of OS/2 sTypoAscender '%s' and sTypoDescender '%s' is not the same as the em-square'%s' for Font %s." % (
                    os2table.sTypoAscender, os2table.sTypoDescender, font.unitsPerEm, font.PostScriptName1))
        ...
        if font.isCID:
            if os2table.sTypoLineGap != font.unitsPerEm:
                print(
                    "	Warning: OS/2 table sTypoLineGap '%s' is not equal to the font em-square '%s' for this CID font %s." % (
                        os2table.sTypoLineGap, font.unitsPerEm, font.PostScriptName1))

        # compare with hhea values.
        if font.sTypoAscender2 != os2table.sTypoAscender:
            print("	Warning: hhea table ascent field '%s' is not the same as OS/2 table sTypoeAscender '%s'. %s" % (
                font.sTypoAscender2, os2table.sTypoAscender, font.PostScriptName1))
        if font.sTypoDescender2 != os2table.sTypoDescender:
            print("	Warning: hhea table descent field '%s' is not the same as OS/2 table sTypoDescender '%s'. %s" % (
                font.sTypoDescender2, os2table.sTypoDescender, font.PostScriptName1))
        if font.sTypoLineGap2 != os2table.sTypoLineGap:
            print("	Warning: hhea table lineGap field '%s' is not the same as OS/2 table sTypoLineGap '%s'. %s" % (
                font.sTypoLineGap2, os2table.sTypoLineGap, font.PostScriptName1))

        # check the sWin values are same as font Bbox.
        if font.fontBBox[1] != -os2table.usWinDescent:
            print(
                "	Warning: OS/2 table usWinDescent field '%s' is not the same as the font bounding box y min '%s'. %s" % (
                    -os2table.usWinDescent, font.fontBBox[1], font.PostScriptName1))
        if font.fontBBox[3] != os2table.usWinAscent:
            print(
                "	Warning: OS/2 table usWinAscent field '%s' is not the same as the font bounding box y max '%s'. %s" % (
                    os2table.usWinAscent, font.fontBBox[3], font.PostScriptName1))
        # make sure that USE_TYPO_METRICS is on
        if not (font.fsSelection & (1 << 7)):
            if os2table.version >= 4:
                print(
                    "	Warning. The OS/2 table version 4 fsSelection field bit 7 'USE_TYPO_METRICS' is not turned on. Windows applications will (eventually) use the OS/2 sTypo fields only if this bit is on. %s." % (
                        font.PostScriptName1))
        else:
            if os2table.version < 4:
                print(
                    "	Error. The OS/2 table version 4 fsSelection field bit 7 'USE_TYPO_METRICS' is set on, but the OS/2 version '%s' is not 4 or greater.. %s." % (
                        os2table.version, font.PostScriptName1))
    ...
    if font.unitsPerEm not in [1000, 2048]:
        print(
            "	Warning: Em square '%s' is not either 1000 or 2048. Some programs will behave oddly with this family. %s." % (
                font.unitsPerEm, font.preferredFamilyName1))
    ...
    for font in fontlist:
        ...
        if numWidthEntries > 9:
            ...
            if (numWidthEntries * 0.5 < numMostPopularWidth) and (len(widthTable) > 1):
                ...
                print(
                    "	Error: tablining More than 50% the glyphs are the same width - this set of numbers is meant to be tabular. ",
                    font.PostScriptName1)
                for entry in widthTable[:-1]:
                    print("non-std width " + str(entry[1]) + " Number of glyphs " + str(entry[0]))
                    for name in entry[2]:
        ...
        if numWidthEntries > 9:
            ...
            if (numWidthEntries * 0.5 < numMostPopularWidth) and (len(widthTable) > 1):
                ...
                print(
                    "	Error: taboldstyle More than 50% the glyphs are the same width - this set of numbers is meant to be tabular. ",
                    font.PostScriptName1)
                for entry in widthTable[:-1]:
                    print("non-std width " + str(entry[1]) + " Number of glyphs " + str(entry[0]))
                    for name in entry[2]:
        ...
        if numWidthEntries > 9:
            ...
            if (numWidthEntries * 0.5 < numMostPopularWidth) and (len(widthTable) > 1):
                ...
                print(
                    "	Error: tabnumerator More than 50% the glyphs are the same width - this set of numbers is meant to be tabular. ",
                    font.PostScriptName1)
                for entry in widthTable[:-1]:
                    print("non-std width " + str(entry[1]) + " Number of glyphs " + str(entry[0]))
                    for name in entry[2]:
...
def checkHintEntry(entry, missingHintsGlyphs, glyphBox, fontPSName):
    ...
    for lo, high, op in hintList:
        ...
        if high:
            ...
            stemWidth = high - lo
            if stemWidth < 0:
                errMsgs += ["Error: hint %s %s %s in glyph %s has a negative stem width. %s." % (
                    lo, high, op, name, fontPSName)]
            if abs(stemWidth) == 1978:
                ...
                errMsgs += [
                    "Error: hint %s %s %s in glyph %s has a bogus stem width, as it is greater than the glyph bbox size %s. %s." % (
                        lo, high, op, name, glyphBBoxSize, fontPSName)]
            if high > max:
                errMsgs += [
                    "Error: hint %s %s %s in glyph %s has a high value greater than the high value (%s) of the glyph bbox. %s." % (
                        lo, high, op, name, max, fontPSName)]
            if lo < min:
                errMsgs += [
                    "Error: hint %s %s %s in glyph %s has a low value less than the low value (%s) of the glyph bbox. %s." % (
                        lo, high, op, name, min, fontPSName)]
        else:
            # is a ghost hint - there is only one value.
            if lo > max:
                errMsgs += [
                    "Error: edge hint %s %s in glyph %s has a value greater than the high value of the glyph bbox (%s). %s." % (
                        lo, op, name, max, fontPSName)]
            elif lo < min:
                errMsgs += [
                    "Error: edge hint %s %s in glyph %s has a value less than the low value of the glyph bbox (%s). %s." % (
                        lo, op, name, min, fontPSName)]
    if errMsgs:
        for msg in errMsgs:
            print(msg)
    ...
    for cmpfFont in fontlist:
        ...
        for key in char_list:
            ...
            if len(t2CharString.bytecode) > 32767:
                print(
                    "Error: charstring for glyph %s is greater than 32k bytes. this can cause problems in Mac OSX 1.3.x and earlier." % (
                        key))
        ...
        if not re.search(r"## glyph", report[:1000]):
            print("Error: could not check hinting for %s. 'tx' command found some error. See following log." % (
                cmpfFont.PostScriptName1))
            print(report)
            return
...
def doSingleTest19():
    ...
    for cmpfFont in fontlist:
        ...
        if not unicodeCmapList:
            print("	Error: font has no Unicode cmap table  (platform, encoding) (0,3) or (3,1) : ",
                  cmpfFont.PostScriptName1)
            continue
        ...
        for code, glyphName in unicodeCmapList:
            if glyphName in nameDict:
                ...
                message = "\tGlyph " + str(glyphName) + " is double-mapped to both unicode " + str(
                    hex(code)) + " " + unicodeComment1 + " and " + str(hex(code2)) + " " + unicodeComment2 + "."
        ...
        if duplicateList:
            print(
                "	Warning: font %s has glyphs mapped to more than one Unicode value. The OTF spec permits this, but it makes it hard for Acrobat to reverse map from Unicode encodings to char codes for searching." % (
                    cmpfFont.PostScriptName1))
...
def doSingleTest21():
    ...
    for font in fontlist:
        ...
        if font.preferredFamilyName3 and (len(font.preferredFamilyName3.strip()) != len(font.preferredFamilyName3)):
            reporter4_fontname.append(font.PostScriptName1)
            reporter4_failedvalue.append(font.preferredFamilyName3)
        if font.preferredSubFamilyName3 and (
                len(font.preferredSubFamilyName3.strip()) != len(font.preferredSubFamilyName3)):
            reporter5_fontname.append(font.PostScriptName1)
            reporter5_failedvalue.append(font.preferredSubFamilyName3)
        if font.MacCompatibleFullName1 and (
                len(font.MacCompatibleFullName1.strip()) != len(font.MacCompatibleFullName1)):
            reporter6_fontname.append(font.PostScriptName1)
            reporter6_failedvalue.append(font.MacCompatibleFullName1)
...
uniLigPattern = re.compile(
    r"^uni([0-8A-Fa-f][0-8A-Fa-f][0-8A-Fa-f][0-8A-Fa-f])([0-8A-Fa-f][0-8A-Fa-f][0-8A-Fa-f][0-8A-Fa-f])")
    ...
    for font in fontlist:
        ...
        for ligName in ligatureNames:
            ...
            for ligComponents in ligComponentsList:
                ...
                try:
                    widthRightComp, lsbRightComp, bottomRightComp, rightRightComp, topRightComp = font.metricsDict[
                        rightComp]
                except KeyError:
                ...
                if widthLig <= (widthLeftComp - gDesignSpaceTolerance):
                    print(
                        "	Warning: Width of ligature %s: %s is less than or the same as that of the left component glyph %s: %s for font %s." % (
                            ligName, widthLig, leftComp, widthLeftComp, font.PostScriptName1))

                diff = abs(lsbLig - lsbLeftComp)
                if diff > gDesignSpaceTolerance:
                    print(
                        "	Warning: left side bearing %s of ligature %s is not equal to the lsb %s of the left side component %s for font %s." % (
                            lsbLig, ligName, lsbLeftComp, leftComp, font.PostScriptName1))
                rsbRightComp = widthRightComp - rightRightComp
                diff = abs(rsbRightComp - rsbLig)
                if diff > gDesignSpaceTolerance:
                    print(
                        "	Warning: right side bearing %s of ligature %s is not equal to the rsb %s of the last component %s for font %s." % (
                            rsbLig, ligName, rsbRightComp, rightComp, font.PostScriptName1))
...
def doSingleTest23():
    ...
    for font in fontlist:
        accentEntries = getAcentEntries(
            font)  # get a list of entries [ accented glyph-name, base-glyph name]. base glyph name may be None, if I couldn't find it
        ...
        for entry in accentEntries:
            try:
                baseName = entry[1]
                accentName = entry[0]
                widthbase, lsbBase = hmtxTable[
                    baseName]  # I do this first so as to not waste time if the base glyph does not exist.
                widthAccent, lsbLig = hmtxTable[accentName]
                diff = abs(widthAccent - widthbase)
                if diff > gDesignSpaceTolerance:
                    print("\tWarning: Width of glyph %s: %s differs from that of the base glyph %s: %s for font %s." % (
                        accentName, widthAccent, baseName, widthbase, font.PostScriptName1))
            except KeyError:
                pass
...
def doSingleTest24():
    ...
    for font in fontlist:
        ...
        if "size" in report:
            match = re.search(
                r"Design Size:\s*(\d+).+?Subfamily Identifier:\s*(\d+).+name table [^:]+:\s*(\d+).+Range Start:\s*(\d+).+?Range End:\s*(\d+)",
                report, re.DOTALL)
            if match:
                ...
                if font.sizeNameID:
                    ...
                    if (designSize < rangeStart) or (designSize > rangeEnd):
                        print(
                            "\tError: 'size' feature design size %s is not within design range %s - %s for font %s." % (
                                designSize, rangeStart, rangeEnd, font.PostScriptName1))
                font.sizeMenuName = ""
                ...
                if not font.sizeMenuName:
                    print(
                        "	Error: the 'size' feature refers to name table name ID '%s', but I can't find it. %s." % (
                            font.sizeNameID, font.PostScriptName1))
            else:
                print("Program error: font has 'size' feature, but could not parse the values for font %s." % (
                    font.PostScriptName1))
...
def doSingleTest26():
    ...
    matchPats = [re.compile(r"^uni([0-9A-F][0-9A-F][0-9A-F][0-9A-F])+$"),
                 re.compile(r"^u[0-9A-F][0-9A-F][0-9A-F][0-9A-F]([0-9A-F]*[0-9A-F]*)$")]
    ...
    for font in fontlist:
        ...
        if font.usDefaultChar != 0:
            print(
                "	Warning: the OS/2 default char is set to char code '%s'; it is most usefully set to 0, aka .notdef. %s" % (
                    font.usDefaultChar, font.PostScriptName1))
    ...
    for font in fontlist:
        if 'CFF ' not in font.ttFont:
            ...
            if notdefGlyphName != ".notdef":
                print("	Error: In TrueType fonts, glyphID 0 should be .notdef rather than '%s'. %s." % (
                    notdefGlyphName, font.PostScriptName1))
            ...
            if nullGlyphName != "NULL":
                if nullGlyphName == ".null":
                    ...
                    print("	Error: In TrueType fonts, glyphID 1 should be NULL rather than '%s'. %s." % (
                        nullGlyphName, font.PostScriptName1))
                    nullGlyphName = None
            ...
            if crGlyphName != "CR":
                if crGlyphName == "nonmarkingreturn":
                    ...
                    print("	Error: In TrueType fonts, glyphID 2 should be 'CR' rather than '%s'. %s." % (
                        crGlyphName, font.PostScriptName1))
                    crGlyphName = None
            ...
            if spaceGlyphName != "space":
                print("	Error: In TrueType fonts, glyphID 3 should be 'space' rather than '%s'. %s." % (
                    spaceGlyphName, font.PostScriptName1))
                spaceGlyphName = None
            ...
            if hasattr(font, "uniNameDict"):
                if nullGlyphName:
                    try:
                        ...
                        if code != 0:
                            print(
                                "	Error: TrueType font should have NULL glyph '%s' encoded at Unicode value 0 rather than %s. %s" % (
                                    nullGlyphName, hex(code), font.PostScriptName1))
                    except KeyError:
                        print("	Error: TrueType font should have NULL glyph '%s' encoded at Unicode value 0. %s" % (
                            nullGlyphName, font.PostScriptName1))
                if crGlyphName:
                    try:
                        ...
                        if code != 0xD:
                            print(
                                "	Error: TrueType font should have CR glyph '%s' encoded at Unicode value 0xD rather than %s. %s" % (
                                    crGlyphName, hex(code), font.PostScriptName1))
                    except KeyError:
                        print("	Error: TrueType font should have CR glyph '%s' encoded at Unicode value 0xD. %s" % (
                            crGlyphName, font.PostScriptName1))
                if spaceGlyphName:
                    try:
                        ...
                        if code != 0x20:
                            print(
                                "	Error: TrueType font should have CR glyph '%s' encoded at Unicode value 0x20 rather than %s. %s" % (
                                    spaceGlyphName, hex(code), font.PostScriptName1))
                    except KeyError:
                        print("	Error: TrueType font should have CR glyph '%s' encoded at Unicode value 0x20. %s" % (
                            spaceGlyphName, font.PostScriptName1))
    ...
    for font in fontlist:
        ...
        if 'CFF ' in font.ttFont:
            ...
            if glyphNameBufferSize > 32767:
                print(
                    "\tError: The total size of the glyph names is greater than the safe limit of 32767 for Mac OSX 10.4.x and earlier by %s characters, and will cause crashes. %s." % (
                        glyphNameBufferSize - 32767, font.PostScriptName1))
            elif ((2 * len(font.glyphnames)) + glyphNameBufferSize) > 32767:
                print(
                    "\tWarning: The total size of the glyph names is getting close to  than the safe limit of 32767 for Mac OSX 10.4.x..%s\tThe safety margin is  %s bytes. If this margin goes below zero, the font will cause crashes. %s" % (
                        os.linesep, 32767 - glyphNameBufferSize, font.PostScriptName1))
        ...
        for gname in glyphnames:
            ...
            if gname in ["endash ", "onedotenleader", "twodotenleader", "threedotenleader"]:
                ...
                if gwidth != enWidth:
                    print("\tError: glyph %s has a width of %s rather than 1/2 the em-square size. %s" % (
                        gname, gwidth, font.PostScriptName1))
                continue
            if gname == "emdash":
                gwidth = htmx_table.metrics[gname][0]
                if gwidth != font.unitsPerEm:
                    print("\tError: glyph %s has a width of %s rather than the em-square size. %s" % (
                        gname, gwidth, font.PostScriptName1))
                continue
            if gname == "figurespace":
                ...
                for tname in ["one.tab", "one.taboldstyle"]:
                    try:
                        ...
                        if twidth != gwidth:
                            print(
                                "\tError: Width (%s) of %s is not the same as the width (%s) of the tabular glyph %s. %s" % (
                                    gwidth, gname, twidth, tname, font.PostScriptName1))
                        break
                    except KeyError:
                        pass
            if gname[0] != ".":
                ...
                for partName in ligatureParts:
                    ...
                    if dictGlyph:
                        if hasattr(dictGlyph, "fin") and dictGlyph.fin and (dictGlyph.fin != partName):
                            ...
                            if isLig:
                                print(
                                    "	Warning. Font uses working name '%s' rather than Adobe final name '%s' in ligature name '%s'. %s" % (
                                        partName, dictGlyph.fin, gname, font.PostScriptName1))
                                ...
                                print(
                                    "	Warning. Font uses working name '%s' rather than Adobe final name '%s'. %s" % (
                                        partName, dictGlyph.fin, font.PostScriptName1))
                        continue
                        ...
                        if dictGlyph:
                            if hasattr(dictGlyph, "fin") and dictGlyph.fin and (dictGlyph.fin != baseName):
                                if isLig:
                                    print(
                                        "	Warning. Font uses working name '%s' rather than Adobe final name '%s' in ligature name '%s'. %s" % (
                                            partName, dictGlyph.fin + "." + nameParts[1], gname, font.PostScriptName1))
                                else:
                                    print(
                                        "	Warning. Font uses working name '%s' rather than Adobe final name '%s'. %s" % (
                                            partName, dictGlyph.fin + "." + nameParts[1], font.PostScriptName1))
                            continue
                    ...
                    if not isUniName:
                        if isLig:
                            print(
                                "	Warning. Glyph name '%s' in ligature name '%s' is neither in the AGD, nor a 'uni' name, and can't be mapped to a Unicode value. %s" % (
                                    partName, gname, font.PostScriptName1))
                        else:
                            print(
                                "	Warning. Glyph name '%s' is neither in the AGD, nor a 'uni' name, and can't be mapped to a Unicode value. %s" % (
                                    partName, font.PostScriptName1))
...
def doSingleTest27():
    ...
    for font in fontlist:
        ...
        for fieldName in ["yStrikeoutSize", "yStrikeoutPosition",
            ...
            if diff > 5:
                print(
                    "\tWarning: OS/2 table field %s of %s differs from default calculated value %s. Please check. %s." % (
                        fieldName, eval("font.%s" % (fieldName)), eval(fieldName), font.PostScriptName1))
...
def doSingleTest28():
    ...
    # Copied from makeotf.
    codePageTable = [
        {"bitNum": 0, "uv1": 0x00EA, "gname1": "ecircumflex", "uv2": None, "gname2": None, "isSupported": -1,
         "script": "latn_"},
        # 1252 Latin 1 (ANSI)     Roman
        {"bitNum": 1, "uv1": 0x0148, "gname1": "ncaron", "uv2": 0x010C, "gname2": "Ccaron", "isSupported": -1,
         "script": "latn_"},
        # 1250 Latin 2 (CE)       CE
        {"bitNum": 2, "uv1": 0x0451, "gname1": "afii10071", "uv2": 0x042F, "gname2": "afii10049", "isSupported": -1,
         "script": "cyrl_"},
        # 1251 Cyrillic (Slavic)  9.0 Cyrillic
        {"bitNum": 3, "uv1": 0x03CB, "gname1": "upsilondieresis", "uv2": None, "gname2": None, "isSupported": -1,
         "script": "grek_"},
        # 1253 Greek              Greek
        {"bitNum": 4, "uv1": 0x0130, "gname1": "Idotaccent", "uv2": None, "gname2": None, "isSupported": -1,
         "script": "latn_"},
        # 1254 Latin 5 (Turkish)  Turkish
        {"bitNum": 5, "uv1": 0x05D0, "gname1": "afii57664", "uv2": None, "gname2": None, "isSupported": -1,
         "script": "hebr_"},
        # 1255 Hebrew             Hebrew
        {"bitNum": 6, "uv1": 0x0622, "gname1": "afii57410", "uv2": None, "gname2": None, "isSupported": -1,
         "script": "arab_"},
        # 1256 Arabic             Arabic
        {"bitNum": 7, "uv1": 0x0173, "gname1": "uogonek", "uv2": None, "gname2": None, "isSupported": -1,
         "script": "latn_"},
        # 1257 Baltic Rim         -
        {"bitNum": 8, "uv1": 0x20AB, "gname1": "dong", "uv2": 0x01B0, "gname2": None, "isSupported": -1,
         "script": "latn_"},
        # 1258 Vietnamese         -
        {"bitNum": 16, "uv1": 0x0E01, "gname1": None, "uv2": None, "gname2": None, "isSupported": -1,
         "script": "thai_"},
        # 874 Thai                Thai
        {"bitNum": 29, "uv1": 0xFB02, "gname1": "fl", "uv2": 0x0131, "gname2": "dotlessi", "isSupported": -1,
         "script": "latn_"},
        # 1252 Latin 1 (ANSI)     Roman
        {"bitNum": 30, "uv1": 0x2592, "gname1": "shade", "uv2": None, "gname2": None, "isSupported": -1,
         "script": "latn_"},
        # OEM character set       -
    ]
    ...
    unicodeTable = [
        {"firstUV": 0x0020, "secondUV": 0x007E, "numRequired": 95, "numFound": 0, "bitNum": 0, "isSupported": 0,
         "blockName": "Basic Latin"},
        {"firstUV": 0x0080, "secondUV": 0x00FF, "numRequired": 128, "numFound": 0, "bitNum": 1, "isSupported": 0,
         "blockName": "Latin-1 Supplement"},
        {"firstUV": 0x0100, "secondUV": 0x017F, "numRequired": 128, "numFound": 0, "bitNum": 2, "isSupported": 0,
         "blockName": "Latin Extended-A"},
        {"firstUV": 0x0180, "secondUV": 0x024F, "numRequired": 208, "numFound": 0, "bitNum": 3, "isSupported": 0,
         "blockName": "Latin Extended-B"},
        {"firstUV": 0x0250, "secondUV": 0x02AF, "numRequired": 96, "numFound": 0, "bitNum": 4, "isSupported": 0,
         "blockName": "IPA Extensions"},
        {"firstUV": 0x02B0, "secondUV": 0x02FF, "numRequired": 80, "numFound": 0, "bitNum": 5, "isSupported": 0,
         "blockName": "Spacing Modifier Letters"},
        {"firstUV": 0x0300, "secondUV": 0x036F, "numRequired": 112, "numFound": 0, "bitNum": 6, "isSupported": 0,
         "blockName": "Combining Diacritical Marks"},
        {"firstUV": 0x0370, "secondUV": 0x03FF, "numRequired": 144, "numFound": 0, "bitNum": 7, "isSupported": 0,
         "blockName": "Greek"},
        {"firstUV": 0x0400, "secondUV": 0x04FF, "numRequired": 256, "numFound": 0, "bitNum": 9, "isSupported": 0,
         "blockName": "Cyrillic"},
        {"firstUV": 0x0530, "secondUV": 0x058F, "numRequired": 96, "numFound": 0, "bitNum": 10, "isSupported": 0,
         "blockName": "Armenian"},
        {"firstUV": 0x0590, "secondUV": 0x05FF, "numRequired": 112, "numFound": 0, "bitNum": 11, "isSupported": 0,
         "blockName": "Hebrew"},
        {"firstUV": 0x0600, "secondUV": 0x06FF, "numRequired": 256, "numFound": 0, "bitNum": 13, "isSupported": 0,
         "blockName": "Arabic"},
        {"firstUV": 0x0900, "secondUV": 0x097F, "numRequired": 128, "numFound": 0, "bitNum": 15, "isSupported": 0,
         "blockName": "Devanagari"},
        {"firstUV": 0x0980, "secondUV": 0x09FF, "numRequired": 128, "numFound": 0, "bitNum": 16, "isSupported": 0,
         "blockName": "Bengali"},
        {"firstUV": 0x0A00, "secondUV": 0x0A7F, "numRequired": 128, "numFound": 0, "bitNum": 17, "isSupported": 0,
         "blockName": "Gurmukhi"},
        {"firstUV": 0x0A80, "secondUV": 0x0AFF, "numRequired": 128, "numFound": 0, "bitNum": 18, "isSupported": 0,
         "blockName": "Gujarati"},
        {"firstUV": 0x0B00, "secondUV": 0x0B7F, "numRequired": 128, "numFound": 0, "bitNum": 19, "isSupported": 0,
         "blockName": "Oriya"},
        {"firstUV": 0x0B80, "secondUV": 0x0BFF, "numRequired": 128, "numFound": 0, "bitNum": 20, "isSupported": 0,
         "blockName": "Tamil"},
        {"firstUV": 0x0C00, "secondUV": 0x0C7F, "numRequired": 128, "numFound": 0, "bitNum": 21, "isSupported": 0,
         "blockName": "Telugu"},
        {"firstUV": 0x0C80, "secondUV": 0x0CFF, "numRequired": 128, "numFound": 0, "bitNum": 22, "isSupported": 0,
         "blockName": "Kannada"},
        {"firstUV": 0x0D00, "secondUV": 0x0D7F, "numRequired": 128, "numFound": 0, "bitNum": 23, "isSupported": 0,
         "blockName": "Malayalam"},
        {"firstUV": 0x0E00, "secondUV": 0x0E7F, "numRequired": 128, "numFound": 0, "bitNum": 24, "isSupported": 0,
         "blockName": "Thai"},
        {"firstUV": 0x0E80, "secondUV": 0x0EFF, "numRequired": 128, "numFound": 0, "bitNum": 25, "isSupported": 0,
         "blockName": "Lao"},
        {"firstUV": 0x10A0, "secondUV": 0x10FF, "numRequired": 96, "numFound": 0, "bitNum": 26, "isSupported": 0,
         "blockName": "Georgian"},
        {"firstUV": 0x1100, "secondUV": 0x11FF, "numRequired": 256, "numFound": 0, "bitNum": 28, "isSupported": 0,
         "blockName": "Hangul Jamo"},
        {"firstUV": 0x1E00, "secondUV": 0x1EFF, "numRequired": 256, "numFound": 0, "bitNum": 29, "isSupported": 0,
         "blockName": "Latin Extended Additional"},
        {"firstUV": 0x1F00, "secondUV": 0x1FFF, "numRequired": 256, "numFound": 0, "bitNum": 30, "isSupported": 0,
         "blockName": "Greek Extended"},
        {"firstUV": 0x2000, "secondUV": 0x206F, "numRequired": 112, "numFound": 0, "bitNum": 31, "isSupported": 0,
         "blockName": "General Punctuation"},
        {"firstUV": 0x2070, "secondUV": 0x209F, "numRequired": 48, "numFound": 0, "bitNum": 32, "isSupported": 0,
         "blockName": "Superscripts and Subscripts"},
        {"firstUV": 0x20A0, "secondUV": 0x20CF, "numRequired": 48, "numFound": 0, "bitNum": 33, "isSupported": 0,
         "blockName": "Currency Symbols"},
        {"firstUV": 0x20D0, "secondUV": 0x20FF, "numRequired": 48, "numFound": 0, "bitNum": 34, "isSupported": 0,
         "blockName": "Combining Marks for Symbols"},
        {"firstUV": 0x2100, "secondUV": 0x214F, "numRequired": 80, "numFound": 0, "bitNum": 35, "isSupported": 0,
         "blockName": "Letterlike Symbols"},
        {"firstUV": 0x2150, "secondUV": 0x218F, "numRequired": 64, "numFound": 0, "bitNum": 36, "isSupported": 0,
         "blockName": "Number Forms"},
        {"firstUV": 0x2190, "secondUV": 0x21FF, "numRequired": 112, "numFound": 0, "bitNum": 37, "isSupported": 0,
         "blockName": "Arrows"},
        {"firstUV": 0x2200, "secondUV": 0x22FF, "numRequired": 256, "numFound": 0, "bitNum": 38, "isSupported": 0,
         "blockName": "Mathematical Operators"},
        {"firstUV": 0x2300, "secondUV": 0x23FF, "numRequired": 256, "numFound": 0, "bitNum": 39, "isSupported": 0,
         "blockName": "Miscellaneous Technical"},
        {"firstUV": 0x2400, "secondUV": 0x243F, "numRequired": 64, "numFound": 0, "bitNum": 40, "isSupported": 0,
         "blockName": "Control Pictures"},
        {"firstUV": 0x2440, "secondUV": 0x245F, "numRequired": 32, "numFound": 0, "bitNum": 41, "isSupported": 0,
         "blockName": "Optical Character Recognition"},
        {"firstUV": 0x2460, "secondUV": 0x24FF, "numRequired": 160, "numFound": 0, "bitNum": 42, "isSupported": 0,
         "blockName": "Enclosed Alphanumerics"},
        {"firstUV": 0x2500, "secondUV": 0x257F, "numRequired": 128, "numFound": 0, "bitNum": 43, "isSupported": 0,
         "blockName": "Box Drawing"},
        {"firstUV": 0x2580, "secondUV": 0x259F, "numRequired": 32, "numFound": 0, "bitNum": 44, "isSupported": 0,
         "blockName": "Block Elements"},
        {"firstUV": 0x25A0, "secondUV": 0x25FF, "numRequired": 96, "numFound": 0, "bitNum": 45, "isSupported": 0,
         "blockName": "Geometric Shapes"},
        {"firstUV": 0x2600, "secondUV": 0x26FF, "numRequired": 256, "numFound": 0, "bitNum": 46, "isSupported": 0,
         "blockName": "Miscellaneous Symbols"},
        {"firstUV": 0x2700, "secondUV": 0x27BF, "numRequired": 192, "numFound": 0, "bitNum": 47, "isSupported": 0,
         "blockName": "Dingbats"},
        {"firstUV": 0x3000, "secondUV": 0x303F, "numRequired": 64, "numFound": 0, "bitNum": 48, "isSupported": 0,
         "blockName": "CJK Symbols and Punctuation"},
        {"firstUV": 0x3040, "secondUV": 0x309F, "numRequired": 96, "numFound": 0, "bitNum": 49, "isSupported": 0,
         "blockName": "Hiragana"},
        {"firstUV": 0x30A0, "secondUV": 0x30FF, "numRequired": 96, "numFound": 0, "bitNum": 50, "isSupported": 0,
         "blockName": "Katakana"},
        {"firstUV": 0x3100, "secondUV": 0x312F, "numRequired": 48, "numFound": 0, "bitNum": 51, "isSupported": 0,
         "blockName": "Bopomofo"},
        {"firstUV": 0x3130, "secondUV": 0x318F, "numRequired": 96, "numFound": 0, "bitNum": 52, "isSupported": 0,
         "blockName": "Hangul Compatibility Jamo"},
        {"firstUV": 0x3200, "secondUV": 0x32FF, "numRequired": 150, "numFound": 0, "bitNum": 54, "isSupported": 0,
         "blockName": "Enclosed CJK Letters and Months"},
        {"firstUV": 0x3300, "secondUV": 0x33FF, "numRequired": 150, "numFound": 0, "bitNum": 55, "isSupported": 0,
         "blockName": "CJK Compatibility"},
        {"firstUV": 0x4E00, "secondUV": 0x9FFF, "numRequired": 16000, "numFound": 0, "bitNum": 59, "isSupported": 0,
         "blockName": "CJK Unified Ideographs"},
        {"firstUV": 0xAC00, "secondUV": 0xD7A3, "numRequired": 5000, "numFound": 0, "bitNum": 56, "isSupported": 0,
         "blockName": "Hangul Syllables"},
        {"firstUV": 0xE000, "secondUV": 0xF8FF, "numRequired": 6400, "numFound": 0, "bitNum": 60, "isSupported": 0,
         "blockName": "Private Use"},
        {"firstUV": 0xF900, "secondUV": 0xFAFF, "numRequired": 150, "numFound": 0, "bitNum": 61, "isSupported": 0,
         "blockName": "CJK Compatibility Ideographs"},
        {"firstUV": 0xFB00, "secondUV": 0xFB4F, "numRequired": 40, "numFound": 0, "bitNum": 62, "isSupported": 0,
         "blockName": "Alphabetic Presentation Forms"},
        {"firstUV": 0xFB50, "secondUV": 0xFDFF, "numRequired": 688, "numFound": 0, "bitNum": 63, "isSupported": 0,
         "blockName": "Arabic Presentation Forms-A"},
        {"firstUV": 0xFE20, "secondUV": 0xFE2F, "numRequired": 16, "numFound": 0, "bitNum": 64, "isSupported": 0,
         "blockName": "Combining Half Marks"},
        {"firstUV": 0xFE30, "secondUV": 0xFE4F, "numRequired": 32, "numFound": 0, "bitNum": 65, "isSupported": 0,
         "blockName": "CJK Compatibility Forms"},
        {"firstUV": 0xFE50, "secondUV": 0xFE6F, "numRequired": 32, "numFound": 0, "bitNum": 66, "isSupported": 0,
         "blockName": "Small Form Variants"},
        {"firstUV": 0xFE70, "secondUV": 0xFEFF, "numRequired": 144, "numFound": 0, "bitNum": 67, "isSupported": 0,
         "blockName": "Arabic Presentation Forms-B"},
        {"firstUV": 0xFF00, "secondUV": 0xFFEF, "numRequired": 150, "numFound": 0, "bitNum": 68, "isSupported": 0,
         "blockName": "Halfwidth and Fullwidth Forms"},
        {"firstUV": 0xFFF0, "secondUV": 0xFFFF, "numRequired": 16, "numFound": 0, "bitNum": 69, "isSupported": 0,
         "blockName": "Specials"},
    ]
    ...
    for font in fontlist:
        ...
        for codePage in codePageTable:
            ...
            for cmapUnicodeTable in cmapUnicodeTables:
                if cmapUnicodeTable:
                    if (codePage["uv1"] in cmapUnicodeTable or (
                            codePage["uv2"] and codePage["uv2"] in cmapUnicodeTable)):
                ...
                for bitNum in range(32):
                    ...
                    if dictBit in codePageDict:
                        if codePageDict[dictBit] and not (codeRange & (1 << bitNum)):
                            print(
                                "\tError: font has OS/2.ulCodePageRange%s bit %s not set, but the test heuristics say it should  be set. %s." % (
                                    codepageIndex + 1, bitNum, font.PostScriptName1))
                        elif (not codePageDict[dictBit]) and (codeRange & (1 << bitNum)):
                            print(
                                "\tError: font has OS/2.ulCodePageRange%s bit %s set, but the test heuristics say it should not be set. %s." % (
                                    codepageIndex + 1, bitNum, font.PostScriptName1))
                    else:
                        if (codeRange & (1 << bitNum)):
                            print(
                                "\tNote: Font has  OS/2.ulCodePageRange%s bit %s set, which is not covered by this programs rules. %s." % (
                                    codepageIndex + 1, bitNum, font.PostScriptName1))
        except AttributeError:
            pass
        ...
        for unicodeBlock in unicodeTable:
            ...
            if cnt * 3 >= unicodeBlock[
                "numRequired"]:  # At the moment, 'numRequired" is et ot the full range. Requiring one third of this is a crude hack.
            ...
            for bitNum in range(32):
                ...
                if blockIndex in unitTableDict:
                    if unitTableDict[blockIndex][0] and not (codeRange & (1 << bitNum)):
                        print(
                            "\tError: font has OS/2.ulUnicodeRange%s bit %s not set for Unicode block %s, but the test heuristics say it should  be set. %s." % (
                                codepageIndex + 1, blockIndex, unitTableDict[blockIndex][1], font.PostScriptName1))
                    elif (not unitTableDict[blockIndex][0]) and (codeRange & (1 << bitNum)):
                        print(
                            "\tError: font has OS/2.ulUnicodeRange%s bit %s set for Unicode block %s, but the test heuristics say it should not be set. %s." % (
                                codepageIndex + 1, blockIndex, unitTableDict[blockIndex][1], font.PostScriptName1))
                else:
                    if codeRange & (1 << bitNum):
                        if (blockIndex == 57):
                            if not haveUVCmap32:
                                print(
                                    "\tError: Font has  OS/2.ulUnicodeRange%s blockIndex %s set, but does not have a 32 bit Unicode cmap table. %s." % (
                                        codepageIndex + 1, blockIndex, font.PostScriptName1))
                        else:
                            print(
                                "\tNote: Font has  OS/2.ulUnicodeRange%s blockIndex %s set, which is not covered by this programs rules. %s." % (
                                    codepageIndex + 1, blockIndex, font.PostScriptName1))
                ...
                try:  # not all fonts have FamilyOtherBlues.
                    for i in range(0, len(fontDict.Private.FamilyOtherBlues), 2):
                        if fontDict.Private.FamilyOtherBlues[i] > fontDict.Private.FamilyOtherBlues[i + 1]:
                            ...
                            print("\tFont:", font.PostScriptName1)
                            print("\tPairs:", fontDict.Private.FamilyOtherBlues[i],
                                  fontDict.Private.FamilyOtherBlues[i + 1])
                            print("\tFamilyOtherBlues:", fontDict.Private.FamilyOtherBlues)
                except AttributeError:
                    pass
            ...
            for fontDict in font.FDArray:
                ...
                for i in range(0, len(bottomZone) - 1, 2):  # compare a pair to the rest
                    for j in range(i + 2, len(bottomZone)):
                        if abs(bottomZone[i] - bottomZone[j]) < (
                                2 * fontDict.Private.BlueFuzz + 1):  # first integer in pair
                            print("\nError: The BottomZone have pairs less than %d units apart." % (
                                    2 * fontDict.Private.BlueFuzz + 1))
                            print("\tFont:", font.PostScriptName1)
                            print("\tValues:", bottomZone[i], bottomZone[j])
                            print("\tBottomZone:", bottomZone)
                        if abs(bottomZone[i + 1] - bottomZone[j]) < (
                                2 * fontDict.Private.BlueFuzz + 1):  # second integer in pair
                            print("\nError: The BottomZone have pairs less than %d units apart." % (
                                    2 * fontDict.Private.BlueFuzz + 1))
                            print("\tFont:", font.PostScriptName1)
                ...
                for i in range(0, len(topZone) - 1, 2):  # compare a pair to the rest
                    for j in range(i + 2, len(topZone)):
                        if abs(topZone[i] - topZone[j]) < (2 * fontDict.Private.BlueFuzz + 1):
                            print("\nError: The TopZone have pairs less than %d units apart." % (
                                    2 * fontDict.Private.BlueFuzz + 1))
                            print("\tFont:", font.PostScriptName1)
                ...
                try:
                    for i in range(0, len(fontDict.Private.BlueValues), 2):
                        ...
                        if (fontDict.Private.BlueScale * 240 * diff) >= 240.0:
                            ...
                            print("\tFont:", font.PostScriptName1)
                            print("\tPairs:", fontDict.Private.BlueValues[i], fontDict.Private.BlueValues[i + 1])
                            print("\tDistance (%d) is greater than 1/BlueScale (%5.2f) " % (
                                diff, 1.0 / fontDict.Private.BlueScale))
                            print("\tBlueValues:", fontDict.Private.BlueValues)
                except AttributeError:
                    print("Skipping test - font dict does not contain OtherBlues", font.PostScriptName1)
                    continue
...
def doFamilyTest2():
    ...
    for name in compatibleFamilyList3.keys():
        ...
        if minCount != maxCount:
            ...
            print("\tin some fonts but not all fonts within the Compatible Family '%s'. Please check fonts '%s'." % (
                name, fontList))
            print(
                "\t{platform, script, language, name ID} combination : Number of fonts in the family with this combination")
            itemList = sorted(LanguageDict.items())
            for entry in itemList:
                print("\t%s\t%s" % (entry[0], entry[1]))
            print(
                "All fonts should have the same set of {platform, script, language, name ID} combinations, so the number of fonts for each combination should be the same, excepting name ID's 16,17,18, and 20.")
    ...
    for name in compatibleFamilyList3.keys():
        ...
        for Language in LanguageList:
            ...
            for font in fontgroup[1:]:
                ...
                if nameID != nameID1:
                    print(
                        "\tError: NameID 16 '%s' for language ID %s in font %s is not the same as '%s' in font %s." % (
                            nameID, Language, font.PostScriptName1, nameID1, font1.PostScriptName1))
...
def doFamilyTest4():
    ...
    for name in preferredFamilyList1.keys():
        ...
        if fByName != fByID:
            print(
                "	Error: in family %s, the fonts with the same size subgroup ID's do not all have the same menu names" % (
                    name))
        ...
        for sid in sizeGroupbyID.keys():
            ...
            if lastList and len(pList) != len(lastList):
                print(
                    "	Warning: in family %s, the 'size' group (id %s, menu name %s) has %s members, while the group (id %s, menu name %s) has %s members." % (
                        name, sid, menuName, len(pList), lastSID, lastMenuName, len(lastList)))
            ...
            sizeCoverage = []
            for font in fList:
                sizeCoverage.append([font.sizeRangeStart, font.sizeRangeEnd, font.PostScriptName1, font.sizeMenuName,
                                     font.sizeSubfFamilyID])
            sizeCoverage.sort()
            error = 0
            ...
            if error:
                print(
                    "	Error: design ranges for size subgroup ID %s, size menu %s in family %s are not contiguous." % (
                        sid, font.sizeMenuName, name))
                for item in errorList:
                    print("previous range: %s - %s for %s, next range: %s - %s for %s. sub group ID %s." % (
                        item[0][0], item[0][1], item[0][2], item[1][0], item[1][1], item[1][2], item[0][3]))
...
def doFamilyTest6():
    ...
    baseBoldRangeDict = {250: (600, 1000), 300: (600, 950), 350: (600, 900), 400: (600, 850), 450: (600, 800),
                         500: (650, 750), 550: (600, 800)}
    for name in compatibleFamilyList3.keys():
        basefont = ""
        boldfont = ""
        for font in compatibleFamilyList3[name]:
        ...
        if basefont == boldfont and len(compatibleFamilyList3[name]) > 2:
            print(
                "\tError: Base font is not Regular face and the group has more than two faces for the group. Compatible family name:",
                name)
            continue
        ...
        try:
            ...
            print(
                "\tError: usWeightClass %s of regular font %s is outside of range that allows style linking to a Bold face: this will result is fake bolding of the Regular face when the Bold style is chsoen." % (
                    basefont.usWeightClass, font.PostScriptName1))
            print("\t\tPermissible range for base font %s in order for it to link to a Bold font: %s - %s" % (
                basefont.PostScriptName1, 250, 550))
            continue

        if boldfont.usWeightClass < boldRange[0] or boldfont.usWeightClass > boldRange[1]:
            print(
                "\tError: usWeightClass '%s'of the Bold font is outside of BOLD RANGE [%s - %s] for the group. Compatible family name: %s" % (
                    boldfont.usWeightClass, boldRange[0], boldRange[1], name))
        ...
        if (boldfont.usWeightClass % 50) != 0:
            print(
                "\tWarning: usWeightClass of the Bold font is within range, but not in increments of 50 for the group. Compatible family name:",
                name)
            print("\t\tBase Font:", basefont.PostScriptName3)
            print("\t\tusWeightClass:", basefont.usWeightClass)
            print("\t\tBold Font:", boldfont.PostScriptName3)
        ...
        for font1 in fontgroup[1:]:
            if font.copyrightStr1 != font1.copyrightStr1:
                ...
                if temp1 != temp2:
                    ...
                    print(
                        "\nNote: These two fonts differ only in the years in the	Copyright String. Preferred family:",
                        name)
        ...
        for font1 in fontgroup[1:]:
            if font.trademarkStr1 != font1.trademarkStr1:
                ...
                if temp1 != temp2:
                    ...
                    print(
                        "\nNote: These two fonts differ only in the years in the	Trademark String. Preferred family:",
                        name)
                print("\tFont 1:", font.PostScriptName1)
    ...
    for name in compatibleFamilyList3.keys():
        ...
        if len(weightClassList) < 2:
            if boldFont and baseFont:
                print("\nError: Bold style font set with same usWeightClass value as the Regular face, for font",
                      boldFont.PostScriptName3)
            continue
        ...
        for i in range(len(fontgroup)):
            ...
            if not fontPanoseStatus == 2:
                if fontPanoseStatus == 1:
                    print("	Warning: ", font.PostScriptName1,
                          " has only the first 4 Panose values set; these are may be default values derived by makeotf.")
                ...
                if 'CFF ' in font.ttFont and (isPanoseMonospaced != font.topDict.isFixedPitch):
                    if isPanoseMonospaced:
                        print(
                            "	Error: OS/2 Panose digit 4 indicates that the font is monospaced, but the CFF top dict IsFixedPitch value is set false.")
                    else:
                        print(
                            "	Error: OS/2 Panose digit 4 indicates that the font is not monospaced, but the CFF top dict IsFixedPitch value is set true.")
                if (isPanoseMonospaced != font.isFixedPitchfromHMTX):
                    if isPanoseMonospaced:
                        print(
                            "	Error: OS/2 Panose digit 4 indicates that the font is monospaced, but there is more than one width value in the htmx table.")
                    else:
                        print(
                            "	Error: OS/2 Panose digit 4 indicates that the font is not monospaced, but there is only one width value in the hmtx table.")
                if 'CFF ' in font.ttFont and (font.topDict.isFixedPitch != font.isFixedPitchfromHMTX):
                    if font.topDict.isFixedPitch:
                        print(
                            "	Error: the CFF top dict IsFixedPitch value is set true, but there is more than one width value in the htmx table.")
                    else:
                        print(
                            "	Error: the CFF top dict IsFixedPitch value is set false, but there is only one width value in the hmtx table.")
            ...
            if font.isBold or font.isItalic:
                if not font.isCID:
                    if CompareWinToMacMenuName(winMenuName, macMenuName):
                        print(
                            "\nError: The Mac and Windows Compatible Names should differ in a style-linked BOLD or Italic font, but do not. Font",
                            font.PostScriptName1)
            ...
            for tableTag in ["GPOS", "GSUB"]:
                ...
                try:
                    ...
                    for scriptRecord in layoutTable.table.ScriptList.ScriptRecord:
                        ...
                        scriptDict[stag] = {}
                        langSysRecords = list(
                            map(lambda rec: [rec.LangSysTag, rec.LangSys], scriptRecord.Script.LangSysRecord))
                ...
                if featDict:
                    if "TUR" in langDict:
                        print("	Error: font uses incorrect language tag TUR rather the TRK in table %s. %s." % (
                            tableTag, font.PostScriptName1))
                    try:
                        rec = scriptDict['DFLT']['dflt']
                    except:
                        print("	Warning: font does not have script 'DFLT' language 'dflt' in table %s. %s." % (
                            tableTag, font.PostScriptName1))
                    try:
                        rec = scriptDict['latn']['dflt']
                    except:
                        print("	Warning: font does not have script 'latn' language 'dflt' in table %s. %s." % (
                            tableTag, font.PostScriptName1))
...
def doFamilyTest13():
    ...
    for name in preferredFamilyList1.keys():
        ...
        if haveError:
            print(
                "\tError: fonts in family of %s do not all have the same setting for the WEIGHT_WIDTH_SLOPE_ONLY bit in the OS/2 selection table." % (
                    name))
            for i in range(numFonts):
                font = fontgroup[i]
                print("\tError: for font %s, WEIGHT_WIDTH_SLOPE_ONLY bit value %s." % (
                    font.FullFontName1, (font.fsSelection & kTestBit) != 0))
            break
        ...
        if firstFontBit:
            for i in range(numFonts):
                ...
                if font.OS2version < 4:
                    print(
                        "\tError: font %s has WEIGHT_WIDTH_SLOPE_ONLY bit in the OS/2 selection table set, but the OS/2 table version is less than 4." % (
                            font.FullFontName1))
                    haveError = 1
        if haveError:
            break
        ...
        for i in range(len(fontgroup)):
            ...
            try:
                ...
                print(
                    "\tError: font %s has the same weight/width/Italic values as font %s in the same family group when WEIGHT_WIDTH_SLOPE_ONLY is set." % (
                        font.FullFontName1, prevName))
            except KeyError:
...
def doFamilyTest14():
    ...
    for name in preferredFamilyList1.keys():
        ...
        if font0.fsType == -1:
            print("\tError: Skipping Embedding permissions report - OS/2 table does not exist in first font",
                  font0.PostScriptName1)
            continue
        if (font0.fsType != 8) and ((not font0.trademarkStr1) or ("Adobe Systems" in font0.trademarkStr1)):
            print("\tError: fsType embedding permission '%s' for '%s' should be 8 for Adobe fonts." % (
                font0.fsType, font0.PostScriptName1))
        ...
        for font in preferredSubFamilyList1[1:]:
            ...
            if font0.fsType != font.fsType:
                print("\tError: fsType embedding permission '%s' for '%s' differs from value '%s' in '%s'." % (
                    font.fsType, font.PostScriptName1, font0.fsType, font0.PostScriptName1))
            if (font.fsType != 8) and ((not font.trademarkStr1) or ("Adobe Systems" in font.trademarkStr1)):
                print(
                    "\tError: fsType embedding permission '%s' for '%s' should be 8 for Adobe fonts, aka OS/2.achVendID == Adobe." % (
                        font.fsType, font.PostScriptName1))
    ...
    for name in preferredFamilyList1.keys():
        ...
        for font in preferredSubFamilyList1[1:]:
            ...
            if underlinePos != font.underlinePos:
                print("\tError: 'post' table underline position '%s' for '%s' differs from value '%s' in '%s'." % (
                    font.underlinePos, font.PostScriptName1, underlinePos, font0.PostScriptName1))
            if underlineThickness != font.underlineThickness:
                print("\tError: 'post' table underline thickness '%s' for '%s' differs from value '%s' in '%s'." % (
                    font.underlineThickness, font.PostScriptName1, underlineThickness, font0.PostScriptName1))
...
def doFamilyTest16():
    ...
    print(
        "\nFamily Test 16: Check that for all faces in a preferred family group, that the width of any glyph is not more than %s times the width of the same glyph in any other face." % (
            kWidthMultiplier))
    for name in preferredFamilyList1.keys():
        ...
        if len(fontgroup) == 1:
            print(
                "\tSkipping Family Test 16: can't usefully compare glyph widths between fonts when there is only one font in a preferred family. %s." % (
                    name))
            continue
        charsetDict = {}
        for font in fontgroup:
            ...
            for gname in charset:
                ...
                for font in fontList:
                    ...
                    try:
                        ...
                        print(
                            "\tError: Glyph '%s' is in font, but is not in the width list. This can happen when the number of glyphs in the maxp table is less than the actual number of glyphs." % (
                                gname))
                if not widthList:
                    continue
                widthList.sort()
                if (widthList[0][0] * kWidthMultiplier < widthList[-1][0]):
                    print("\tWarning: width (%s) of glyph %s in %s is more than %s times the width (%s) in %s." % (
                        widthList[-1][0], gname, widthList[-1][1], kWidthMultiplier, widthList[0][0], widthList[0][1]))
...
def doFamilyTest17():
    ...
    for name in preferredFamilyList1.keys():
        ...
        for font in fontgroup:
            if font.OS2version < 4:
                print("\tWarning: The font %s should have an OS/2 table version of at least 4 instead of %s." % (
                    font.PostScriptName1, font.OS2version))
...
def doFamilyTest18():
    ...
    for name in compatibleFamilyList3.keys():
        ...
        for subgroup in groups:
            ...
            if len(tempBlues) > 14:
                print("	Error: font BlueValues has '%s' zones, but is allowed to hold at most 7. %s" % (
                    len(tempBlues) / 2, font.PostScriptName1))
            if (len(tempBlues) % 2) != 0:
                print(
                    "	Error: font BlueValues has '%s' integer values, List of values must be even as it takes a pair to describe an alignment zone. %s" % (
                        len(tempBlues), font.PostScriptName1))
            tempBlues.sort()
            ...
            if tempBlues[1] < font.fontBBox[1]:
                print(
                    "	Error: font BlueValues has lowest zone (%s,%s) outside of minimum y of font bounding box '%s'. %s" % (
                        tempBlues[0], tempBlues[1], font.fontBBox[1], font.PostScriptName1))
            if tempBlues[-2] > font.fontBBox[3]:
                print(
                    "	Error: font BlueValues has highest zone (%s,%s) outside of maximum y of font bounding box '%s'. %s" % (
                        tempBlues[-2], tempBlues[-1], font.fontBBox[3], font.PostScriptName1))

            if font.OtherBlues and (len(tempBlues) < 2):
                tempBlues = copy.copy(font.OtherBlues)
                if len(tempBlues) > 10:
                    print("	Error: font OtherBlues has '%s' zones, but is allowed to hold at most 5. %s" % (
                        len(tempBlues) / 2, font.PostScriptName1))
                if (len(tempBlues) % 2) != 0:
                    print(
                        "	Error: font OtherBlues has '%s' integer values, List of values must be even as it takes a pair to describe an alignment zone. %s" % (
                            len(tempBlues), font.PostScriptName1))
                tempBlues.sort()
                ...
                if tempBlues[1] < font.fontBBox[1]:
                    print(
                        "	Error: font OtherBlues has lowest zone (%s,%s) outside of minimum y of font bounding box '%s'. %s" % (
                            tempBlues[0], tempBlues[1], font.fontBBox[1], font.PostScriptName1))
                if tempBlues[-2] > font.fontBBox[3]:
                    print(
                        "	Error: font OtherBlues has highest zone (%s,%s) outside of maximum y of font bounding box '%s'. %s" % (
                            tempBlues[-2], tempBlues[-1], font.fontBBox[3], font.PostScriptName1))
            ...
            for font1 in subgroup[1:]:
                ...
                if len(tempBlues) > 14:
                    print("	Error: font BlueValues has '%s' zones, but is allowed to hold at most 7. %s" % (
                        len(tempBlues) / 2, font1.PostScriptName1))
                if (len(tempBlues) % 2) != 0:
                    print(
                        "	Error: font BlueValues has '%s' integer values, List of values must be even as it takes a pair to describe an alignment zone. %s" % (
                            len(tempBlues), font1.PostScriptName1))
                tempBlues.sort()
                ...
                if tempBlues[1] < font1.fontBBox[1]:
                    print(
                        "	Error: font BlueValues has lowest zone (%s,%s) outside of minimum y of font bounding box '%s'. %s" % (
                            tempBlues[0], tempBlues[1], font1.fontBBox[1], font1.PostScriptName1))
                if tempBlues[-2] > font1.fontBBox[3]:
                    print(
                        "	Error: font BlueValues has highest zone (%s,%s) outside of maximum y of font bounding box '%s'. %s" % (
                            tempBlues[-2], tempBlues[-1], font1.fontBBox[3], font1.PostScriptName1))
...
def doFamilyTest19():
    ...
    for name in preferredFamilyList1.keys():
        ...
        for font in fontgroup:
            ...
            for FBEntry in FBList:
                ...
                try:  # not all fonts have FamilyBlues
                    ...
                    try:
                        testFamilyBlues = eval("font.FDArray[0].Private.%s" % (
                            BKey))  # If a font does not have Private.FamilyBlues, it's Private.FamilyBlues are considered to be the same as it's BlueValues.
                        testFamilyBlues = tuple(testFamilyBlues)
                    except AttributeError:
                        testFamilyBlues = ()
        ...
        if (not seenFamilyBlues) and hasattr(fontgroup[0], "BlueValues"):
            ...
            if blueValuesDiffer:
                print(
                    "	Warning. The fonts in the family group %s do not have  FamilyBlue values. This font feature helps with alignment of different styles of the same family on a text line." % (
                        name))
            continue
        ...
        for FBEntry in FBList:
            ...
            for tempBlues in FBDict.keys():
                ...
                if len(fontList) > 1:
                    if not regularFont:
                        print(
                            "	Warning: In family %s, a group of fonts have %s, but there is no base font with the same value in its %s array. This affects" % (
                                name, FBKey, BKey))
                        for font in fontList:
                    ...
                    if tempBlues:
                        print(
                            "	Error: In family %s, a font has a unique %s array. This is certainly unintended. %s." % (
                                name, FBKey, font.PostScriptName1))
                ...
                if len(tempBlues) > 14:
                    print(
                        "	Error: In family %s, %s has '%s' zones, but is allowed to hold at most 7. This affects:" % (
                            name, FBKey, len(tempBlues) / 2))
                    for font in fontList:
                        print("\t\t", font.PostScriptName1)
                if (len(tempBlues) % 2) != 0:
                    print(
                        "	Error: In family %s, %s has '%s' integer values. List of values must be even as it takes a pair to describe an alignment zone. This affects:" % (
                            name, FBKey, len(tempBlues)))
                    for font in fontList:
                        print("\t\t", font.PostScriptName1)
...
def print_font_metric_report():
        ...
        if font0.sTypoAscender == -1:
            ...
            if diff == 0:
                ...
                print("%5d%5d%5d%5d%5d" % (
                    font0.sTypoAscender, font0.sTypoDescender, font0.sTypoLineGap, font0.sCapHeight, font0.sxHeight))
                continue
            print("Font									TypoAscent/TypoDescent/LineGap/CapHeight/sxHeight")
            for font in preferredSubFamilyList1:
                print("%40s%5d%8d%8d%8d%8d" % (
                    ("%s:" % font.PostScriptName1).ljust(40), font.sTypoAscender, font.sTypoDescender,
                    font.sTypoLineGap,
                    font.sCapHeight, font.sxHeight))
    ...
    for name in preferredFamilyList1.keys():
        ...
        font0 = preferredSubFamilyList1[0]
        if font0.fsType == -1:
            print("Skipping Embedding permissions report - OS/2 table does not exist in base font",
                  font0.PostScriptName1)
        else:
    ...
    for name in preferredFamilyList1.keys():
        print("\nPreferred Family:", name)
        preferredSubFamilyList1 = preferredFamilyList1[name]
        widthClassTable = ['Ultra-condensed', 'Extra-condensed', 'Condensed', 'Semi-condensed', 'Medium (normal)',
        ...
        if font0.usWidthClass == -1:
            ...
            for font in sort_width(preferredSubFamilyList1):
                print(("%s:" % font.PostScriptName1).ljust(40), font.usWidthClass,
                      widthClassTable[font.usWidthClass - 1])
...
def print_panose_report():
    ...
    kind2 = [familykind]
    kind2.append(["Any", "No Fit", "Cove", "Obtuse Cove", "Square Cove", "Obtuse Square Cove", "Square", "Thin", "Oval",
                  "Exaggerated", "Triangle", "Normal Sans", "Obtuse Sans", "Perpendicular Sans", "Flared", "Rounded"])
    kind2.append(["Any", "No Fit", "Very Light", "Light", "Thin", "Book", "Medium", "Demi", "Bold", "Heavy", "Black",
                  "Extra Black"])
    kind2.append(["Any", "No Fit", "Old Style", "Modern", "Even Width", "Extended", "Condensed", "Very Extended",
                  "Very Condensed", "Monospaced"])
    kind2.append(
        ["Any", "No Fit", "None", "Very Low", "Low", "Medium Low", "Medium", "Medium High", "High", "Very High"])
    kind2.append(["Any", "No Fit", "No Variation", "Gradual/Diagonal", "Gradual/Transitional", "Gradual/Vertical",
                  "Gradual/Horizontal", "Rapid/Vertical", "Rapid/Horizontal", "Instant/Vertical", "Instant/Horizontal"])
    kind2.append(["Any", "No Fit", "Straight Arms/Horizontal", "Straight Arms/Wedge", "Straight Arms/Vertical",
                  "Straight Arms/Single Serif", "Straight Arms/Double Serif", "Non-Straight/Horizontal",
                  "Non-Straight/Wedge", "Non-Straight/Vertical", "Non-Straight/Single Serif",
                  "Non-Straight/Double Serif"])
    kind2.append(
        ["Any", "No Fit", "Normal/Contact", "Normal/Weighted", "Normal/Boxed", "Normal/Flattened", "Normal/Rounded",
    ...
    kind2.append(
        ["Any", "No Fit", "Standard/Trimmed", "Standard/Pointed", "Standard/Serifed", "High/Trimmed", "High/Pointed",
         "High/Serifed", "Constant/Trimmed", "Constant/Pointed", "Constant/Serifed", "Low/Trimmed", "Low/Pointed",
         "Low/Serifed"])
    kind2.append(
        ["Any", "No Fit", "Constant/Small", "Constant/Standard", "Constant/Large", "Ducking/Small", "Ducking/Standard",
         "Ducking/Large"])
    field2 = ["Family Kind", "Serif Style", "Weight", "Proportion", "Contrast", "Stroke Variation", "Arm Style",
              "Letterform", "Midline", "X-height"]
    kind3 = [familykind]
    kind3.append(["Any", "No Fit", "Flat Nib", "Pressure Point", "Engraved", "Ball (Round Cap)", "Brush", "Rough",
                  "Felt Pen/Brush Tip", "Wild Brush - Drips a lot"])
    kind3.append(["Any", "No Fit", "Very Light", "Light", "Thin", "Book", "Medium", "Demi", "Bold", "Heavy", "Black",
                  "Extra Black (Nord)"])
    ...
    kind3.append(
        ["Any", "No Fit", "None", "Very Low", "Low", "Medium Low", "Medium", "Medium High", "High", "Very High"])
    kind3.append(["Any", "No Fit", "Roman Disconnected", "Roman Trailing", "Roman Connected", "Cursive Disconnected",
                  "Cursive Trailing", "Cursive Connected", "Blackletter Disconnected", "Blackletter Trailing",
                  "Blackletter Connected"])
    kind3.append(["Any", "No Fit", "Upright / No Wrapping", "Upright / Some Wrapping", "Upright / More Wrapping",
                  "Upright / Extreme Wrapping", "Oblique / No Wrapping", "Oblique / Some Wrapping",
                  "Oblique / More Wrapping", "Oblique / Extreme Wrapping", "Exaggerated / No Wrapping",
                  "Exaggerated / Some Wrapping", "Exaggerated / More Wrapping", "Exaggerated / Extreme Wrapping"])
    kind3.append(["Any", "No Fit", "None / No loops", "None / Closed loops", "None / Open loops", "Sharp / No loops",
                  "Sharp / Closed loops", "Sharp / Open loops", "Tapered / No loops", "Tapered / Closed loops",
                  "Tapered / Open loops", "Round / No loops", "Round / Closed loops", "Round / Open loops"])
    kind3.append(["Any", "No Fit", "Very Low", "Low", "Medium", "High", "Very High"])
    field3 = ["Family Kind", "Tool kind", "Weight", "Spacing", "Aspect Ratio", "Contrast", "Topology", "Form",
              "Finials", "X-Ascent"]
    kind4 = [familykind]
    kind4.append(
        ["Any", "No Fit", "Derivative", "Non-standard Topology", "Non-standard Elements", "Non-standard Aspect",
         "Initials", "Cartoon", "Picture Stems", "Ornamented", "Text and Background", "Collage", "Montage"])
    kind4.append(["Any", "No Fit", "Very Light", "Light", "Thin", "Book", "Medium", "Demi", "Bold", "Heavy", "Black",
                  "Extra Black"])
    kind4.append(
        ["Any", "No fit", "Super Condensed", "Very Condensed", "Condensed", "Normal", "Extended", "Very Extended",
         "Super Extended", "Monospaced"])
    kind4.append(
        ["Any", "No Fit", "None", "Very Low", "Low", "Medium Low", "Medium", "Medium High", "High", "Very High",
         "Horizontal Low", "Horizontal Medium", "Horizontal High", "Broken"])
    kind4.append(["Any", "No Fit", "Cove", "Obtuse Cove", "Square Cove", "Obtuse Square Cove", "Square", "Thin", "Oval",
                  "Exaggerated", "Triangle", "Normal Sans", "Obtuse Sans", "Perpendicular Sans", "Flared", "Rounded",
                  "Script"])
    kind4.append(["Any", "No Fit", "None - Standard Solid Fill", "White / No Fill", "Patterned Fill", "Complex Fill",
                  "Shaped Fill", "Drawn / Distressed"])
    kind4.append(
        ["Any", "No Fit", "None", "Inline", "Outline", "Engraved (Multiple Lines)", "Shadow", "Relief", "Backdrop"])
    kind4.append(
        ["Any", "No Fit", "Standard", "Square", "Multiple Segment", "Deco (E,M,S) Waco midlines", "Uneven Weighting",
         "Diverse Arms", "Diverse Forms", "Lombardic Forms", "Upper Case in Lower Case", "Implied Topology",
         "Horseshoe E and A", "Cursive", "Blackletter", "Swash Variance"])
    kind4.append(["Any", "No Fit", "Extended Collection", "Litterals", "No Lower Case", "Small Caps"])
    field4 = ["Family Kind", "Class", "Weight", "Aspect", "Contrast", "Serif Variant", "Treatment", "Lining",
              "Topology", "Range of Characters"]
    kind5 = [familykind]
    kind5.append(
        ["Any", "No Fit", "Montages", "Pictures", "Shapes", "Scientific", "Music", "Expert", "Patterns", "Boarders",
         "Icons", "Logos", "Industry specific"])
    kind5.append(["Any", "No Fit"])
    kind5.append(["Any", "No Fit", "Proportional Spaced", "Monospaced"])
    kind5.append(["Any", "No Fit"])
    kind5.append(
        ["Any", "No Fit", "No Width", "Exceptionally Wide", "Super Wide", "Very Wide", "Wide", "Normal", "Narrow",
         "Very Narrow"])
    kind5.append(
        ["Any", "No Fit", "No Width", "Exceptionally Wide", "Super Wide", "Very Wide", "Wide", "Normal", "Narrow",
         "Very Narrow"])
    ...
    kind5.append(
        ["Any", "No Fit", "No Width", "Exceptionally Wide", "Super Wide", "Very Wide", "Wide", "Normal", "Narrow",
         "Very Narrow"])
    field5 = ["Family Kind", "Kind", "Weight", "Spacing", "Aspect ratio & contrast", "Aspect ratio of character 94",
              "Aspect ratio of character 119", "Aspect ratio of character 157", "Aspect ratio of character 163",
...
def main():
    ...
    print("Number of preferred families:", len(preferredFamilyList1.keys()),
          "[%s]" % ', '.join(["'%s'" % name for name in preferredFamilyList1.keys()]))
